...
const cards = [
    { title: 'Spotify', text: 'Ability to view most liked songs on spotify, search for artists and songs, and view your own statistics. All done through Spotify’s public API.', path: 'https://spot.poxen.dev', tech: ['React', 'REST API', 'Scss'], links: [{ path: 'https://github.com/Poxie/spotify-app', icon: <GithubIcon /> }], date: 'August, 2021' },
    { title: 'Graphing', text: 'A website allowing you to insert your own values to create beautiful looking charts of your choice. You have the ability to extract the chart into an image.', path: 'https://graph.poxen.dev', tech: ['React', 'Scss', 'SVG'], links: [{ path: 'https://github.com/Poxie/graph-app', icon: <GithubIcon /> }], date: 'August, 2021' },
