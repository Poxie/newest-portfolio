...
const cards = [
    ...
    { id: 'graph', title: 'Graphing', text: 'A website allowing you to insert your own values to create beautiful looking charts of your choice. You have the ability to extract the chart into an image.', path: 'https://graph.poxen.dev', tech: ['React', 'Scss', 'SVG'], links: [{ path: 'https://github.com/Poxie/graph-app', icon: <GithubIcon /> }], date: 'August, 2021' },
